...
<html lang="en">
  <head>
    ...
    <title>HOTELERIA Y TURIMO POPAYAN 2022</title>
  </head>
  <body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/logo.png" width="120" height="120" alt="Hotel y Restaurante Popayan"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        <input class="form-control me-2" type="Buscar Id" placeholder="Buscar Id" aria-label="Buscar Id">
