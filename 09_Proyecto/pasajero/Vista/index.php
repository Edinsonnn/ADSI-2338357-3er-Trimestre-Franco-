...
<header class="p-3 bg-dark text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <a href="../../Index.php"><button type="button" class="btn btn-info" _msthash="1717859" _msttexthash="264433">Volver</button></a>
    </div>
  </header>
...
<table class="table">
  ...
  <tbody>
      ...
      ?>
    <tr>
      <th scope="row">1<?= $listarUsuarios['id_usuario'];?> </th>
      <th scope="row">1<?= $listarUsuarios['nombres'];?> </th>
      <th scope="row">1<?= $listarUsuarios['apellidos'];?> </th>
      <th scope="row">1<?= $listarUsuarios['cedula'];?> </th>
    </tr>
    <tr>
